...
class TestAudioToText(unittest.TestCase):
    ...
    def test_transcribe_audio_english(self, mock_file, mock_load_model):
        ...
        transcribe_audio_file(input_file="dummy_audio.mp3", output_file="dummy_transcription.txt", language="en")
    ...
    def test_transcribe_audio_spanish(self, mock_file, mock_load_model):
        ...
        transcribe_audio_file(input_file="dummy_audio.mp3", output_file="dummy_transcription.txt", language="es")
    ...
    def test_transcribe_audio_chinese(self, mock_file, mock_load_model):
        ...
        transcribe_audio_file(input_file="dummy_audio.mp3", output_file="dummy_transcription.txt", language="zh")
    ...
    def test_transcribe_audio_korean(self, mock_file, mock_load_model):
        ...
        transcribe_audio_file(input_file="dummy_audio.mp3", output_file="dummy_transcription.txt", language="ko")
